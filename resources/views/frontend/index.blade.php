                        ...
                        <div class="banner_text_iner">
                            ...
                            <div class="banner_btn">
                                <div class="banner_btn_iner">
                                    <a href="#" class="btn_2">Reservation <img src="{{asset('frontend/dingoimg/icon/left_1.svg')}}" alt=""></a>
                                </div>
                                <a href="https://www.youtube.com/watch?v=pBFQdxA-apI" class="popup-youtube video_popup">
                                    <span><img src="{{asset('frontend/dingoimg/icon/play.svg')}}" alt=""></span> Watch our story</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/food_item/food_item_1.png')}}" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/food_item/food_item_2.png')}}" alt="">
                        </div>
                        <div class="single_blog_text">
                            <h3>Cremy Noodles</h3>
                            <p>Was brean shed moveth day yielding tree yielding day were female and </p>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/food_item/food_item_3.png')}}" alt="">
                        </div>
                        <div class="single_blog_text">
                            <h3>Honey Meat</h3>
                            <p>Was brean shed moveth day yielding tree yielding day were female and </p>
                ...
                <div class="col-lg-6">
                    <div class="nav nav-tabs food_menu_nav" id="myTab" role="tablist">
                        <a class="active" id="Special-tab" data-toggle="tab" href="#Special" role="tab"
                           aria-controls="Special" aria-selected="false">Special <img src="{{asset('frontend/dingoimg/icon/play.svg')}}"
                                                                                      alt="play"></a>
                        <a id="Breakfast-tab" data-toggle="tab" href="#Breakfast" role="tab" aria-controls="Breakfast"
                           aria-selected="false">Breakfast <img src="{{asset('frontend/dingoimg/icon/play.svg')}}" alt="play"></a>
                        <a id="Launch-tab" data-toggle="tab" href="#Launch" role="tab" aria-controls="Launch"
                           aria-selected="false">Launch <img src="{{asset('frontend/dingoimg/icon/play.svg')}}" alt="play"></a>
                        <a id="Dinner-tab" data-toggle="tab" href="#Dinner" role="tab" aria-controls="Dinner"
                           aria-selected="false">Dinner <img src="{{asset('frontend/dingoimg/icon/play.svg')}}" alt="play"> </a>
                        <a id="Sneaks-tab" data-toggle="tab" href="#Sneaks" role="tab" aria-controls="Sneaks"
                           aria-selected="false">Sneaks <img src="{{asset('frontend/dingoimg/icon/play.svg')}}" alt="play"></a>
                    </div>
                </div>
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-6">
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_1.png')}}" class="mr-3" alt="...">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_2.png')}}" class="mr-3" alt="...">
                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_3.png')}}" class="mr-3" alt="...">
                                        <div class="media-body align-self-center">
                                ...
                                <div class="col-sm-6 col-lg-6">
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_4.png')}}" class="mr-3" alt="...">
                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_5.png')}}" class="mr-3" alt="...">
                                        <div class="media-body align-self-center">
                                    ...
                                    <div class="single_food_item media">
                                        <img src="{{asset('frontend/dingoimg/food_menu/single_food_6.png')}}" class="mr-3" alt="...">
                                        <div class="media-body align-self-center">
                                            <h3>Chicken Roast</h3>
                                            <p>They're wherein heaven seed hath nothing</p>
                                            <h5>$40.00</h5>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/post/blog_1.png')}}" alt="">
                        </div>
                        <div class="single_blog_text">
                            <div class="date">
                            ...
                            <h3><a href="{{route('post.index')}}">Adama kind deep gatherin first over fter his great</a></h3>
                            <a href="#" class="btn_3">Read More <img src="{{asset('frontend/dingoimg/icon/left_1.svg')}}" alt=""></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/post/blog_2.png')}}" alt="">
                        </div>
                        <div class="single_blog_text">
                            <div class="date">
                                <a href="#" class="date_item">Apr 06, 2019 </a>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="{{asset('frontend/dingoimg/post/blog_3.png')}}" alt="">
                        </div>
                        <div class="single_blog_text">
                            <div class="date">
                                <a href="#" class="date_item">Apr 06, 2019 </a>
